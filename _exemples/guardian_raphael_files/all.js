/*1390498607,178570821,JIT Construction: v1091664,en_US*/
...
try {
	window.FB || (function(window) {
		...
		__d("XDConfig", [], {
			...
			"Flash": {
				"path": "http:\/\/m-static.ak.fbcdn.net\/rsrc.php\/v1\/yS\/r\/NoZWYE2GRkt.swf"
			},
			"useCdn": true
		});
		__d("UrlMapConfig", [], {
		...
		__d("ApiClientConfig", [], {
			"FlashRequest": {
				"swfUrl": "http:\/\/m-static.ak.fbcdn.net\/rsrc.php\/v1\/yB\/r\/YV5wijq5fkW.swf"
			}
		});
		...
		__d("sdk.XD", ["sdk.Content", "sdk.createIframe", "sdk.feature", "sdk.Event", "guid", "Log", "QueryString", "Queue", "resolveURI", "resolveWindow", "sdk.RPC", "sdk.Runtime", "UrlMap", "URL", "wrapFunction", "XDM", "XDConfig"], function(a, b, c, d, e, f) {
			...
			function ma(qa, ra) {
				...
				if (!ra)
					if (qa.xd_sig == ca) ra = qa.xd_origin;
				if (qa.xd_action) {
					la(qa, ra);
					return;
				}
			...
			function w(aa) {
				...
				ES5(ba, 'forEach', true, function(ca) {
					...
					if (o) {
						...
						o(ga);
						setTimeout(fa, 200);
					} else fa(); if (Math.random() <= 1 / 1000) g(k.getClientID() + '/occludespopups', 'post', {});
				});
			}
			...
			var g = b('sdk.ErrorHandling'),
				...
				l = {
					...
					invokeHandler: function(m, n, o) {
						...
						if (m.apply) g.unguard(m).apply(n, o || []);
					},
